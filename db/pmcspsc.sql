...
INSERT INTO `QRTZ_SCHEDULER_STATE` VALUES ('RenrenScheduler','soldier-RESCUER-R720-15IKBN1575205254039',1575205631853,15000);
...
INSERT INTO `QRTZ_TRIGGERS` VALUES ('RenrenScheduler','TASK_1','DEFAULT','TASK_1','DEFAULT',NULL,1575207000000,-1,5,'WAITING','CRON',1575161096000,0,NULL,2,_binary '�\�\0sr\0org.quartz.JobDataMap���迩�\�\0\0xr\0&org.quartz.utils.StringKeyDirtyFlagMap�\�\��\�](\0Z\0allowsTransientDataxr\0org.quartz.utils.DirtyFlagMap\�.�(v\n\�\0Z\0dirtyL\0mapt\0Ljava/util/Map;xpsr\0java.util.HashMap\��\�`\�\0F\0\nloadFactorI\0	thresholdxp?@\0\0\0\0\0w\0\0\0\0\0\0t\0\rJOB_PARAM_KEYsr\00com.soldier.modules.job.entity.ScheduleJobEntity\0\0\0\0\0\0\0\0L\0beanNamet\0Ljava/lang/String;L\0\ncreateTimet\0Ljava/util/Date;L\0cronExpressionq\0~\0	L\0jobIdt\0Ljava/lang/Long;L\0paramsq\0~\0	L\0remarkq\0~\0	L\0statust\0Ljava/lang/Integer;xpt\0testTasksr\0java.util.Datehj�KYt\0\0xpw\0\0n�n\0xt\00 0/30 * * * ?sr\0java.lang.Long;�\�̏#\�\0J\0valuexr\0java.lang.Number����\��\0\0xp\0\0\0\0\0\0\0t\0renrent\0参数测试sr\0java.lang.Integer⠤���8\0I\0valuexq\0~\0\0\0\0\0x\0');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='结题附件';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='结题信息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pm_fund_info` VALUES (1,4,12,14,8,10,9,10,3,9,11,9,95,0),(2,1,12,14,8,10,9,10,3,9,11,9,95,0),(3,2,12,14,8,10,9,10,3,9,11,9,95,0),(4,3,12,14,8,10,9,10,3,9,11,9,95,0);
...
INSERT INTO `pm_item_attach` VALUES (1,1,'pmsocspsc1.sql','/home/soldier/SOLDIER/IDE_project/idea_project/pmcspsc/target/4054477176442732647/pmsocspsc1.sql',0),(2,4,'pmsocspsc1.sql','/home/soldier/SOLDIER/IDE_project/idea_project/pmcspsc/target/4054477176442732647/pmsocspsc1.sql',0),(3,2,'pmsocspsc1.sql','/home/soldier/SOLDIER/IDE_project/idea_project/pmcspsc/target/4054477176442732647/pmsocspsc1.sql',0),(4,3,'pmsocspsc1.sql','/home/soldier/SOLDIER/IDE_project/idea_project/pmcspsc/target/4054477176442732647/pmsocspsc1.sql',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='项目立项申请表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pm_item_info` VALUES (1,'测试1.1','测试1',0,2,'测试1','2019-12-18','2019-12-24','测试1','测试1','测试1','2019-12-11','测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1',0,0,0),(2,'测试1','测试1',0,2,'测试1','2019-12-18','2019-12-24','测试1','测试1','测试1','2019-12-11','测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1',2,0,0),(3,'测试1','测试1',0,2,'测试1','2019-12-18','2019-12-24','测试1','测试1','测试1','2019-12-11','测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1',1,0,0),(4,'测试1','测试1',0,2,'测试1','2019-12-18','2019-12-24','测试1','测试1','测试1','2019-12-11','测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1测试1',1,0,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='项目立项回退表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pm_item_info_retreat` VALUES (1,1,'杀毒爱',0),(2,1,'再来一次',0);
...
CREATE TABLE `pm_team_info` (
  ...
  `item_info_id` varchar(255) DEFAULT NULL COMMENT '立项id',
  ...
  `award_grade` varchar(255) DEFAULT NULL COMMENT '获奖级别：国家级：区级',
  `award_info` varchar(255) DEFAULT NULL COMMENT '获奖',
...
CREATE TABLE `pm_team_person_info` (
  ...
  `person_code` char(1) DEFAULT NULL COMMENT '学号',
  `person_name` char(1) DEFAULT NULL COMMENT '姓名',
  `person_institute` char(1) DEFAULT NULL COMMENT '学院',
  `person_class` char(1) DEFAULT NULL COMMENT '班级',
  `person_grade` char(1) DEFAULT NULL COMMENT '年级',
  `person_major` char(1) DEFAULT NULL COMMENT '专业',
  `person_email` char(1) DEFAULT NULL COMMENT '邮箱',
  `person_phone` char(1) DEFAULT NULL COMMENT '电话',
...
CREATE TABLE `schedule_job_log` (
  ...
  PRIMARY KEY (`log_id`),
  KEY `job_id` (`job_id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COMMENT='定时任务日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_captcha` VALUES ('05ce9695-0773-4f12-8a12-d4a867e4b591','effg7','2019-12-01 20:32:25'),('d7778325-1058-4ecb-8593-cfcc6de26a23','b8m44','2019-12-01 20:37:16');
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COMMENT='系统日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_role_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8mb4 COMMENT='角色与菜单对应关系';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_user_token` VALUES (1,'2db4bc190219b7761d1a3c06169449d9','2019-12-02 09:02:20','2019-12-01 21:02:20'),(2,'ebba5c5bb178233ee80e0ee49ce5e354','2019-12-02 08:29:55','2019-12-01 20:29:55'),(3,'34ea873c308e22d35bd8addd241ff24c','2019-12-02 08:29:17','2019-12-01 20:29:17');
...
-- Dump completed on 2019-12-01 21:08:29
